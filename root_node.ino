...
#define   STATION_SSID     "WiFi"                      // Enter Wi-Fi SSID (Your PC/Laptop should be connected to same network)
...
IPAddress mqttBroker(192, 168, 0, 154);                     // Enter Local ip address of your PC/Laptop
